...
const strengthLabel = (p) => {
  ...
  const levels = [null, { label: 'Weak', color: '#f43f5e', w: '25%' }, { label: 'Fair', color: '#f59e0b', w: '50%' }, { label: 'Good', color: '#3b82f6', w: '75%' }, { label: 'Strong', color: '#10b981', w: '100%' }];
  return levels[s];
};
    ...
    <div className="auth-bg">
      <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.32 }}
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.8rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>Join CodeForge AI — your AI-powered engineering platform</p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type="text" className="form-input" placeholder="Jane Developer" value={fullName} onChange={e => setFullName(e.target.value)} style={{ paddingLeft: '38px' }} required />
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type="email" className="form-input" placeholder="jane@company.com" value={email} onChange={e => setEmail(e.target.value)} style={{ paddingLeft: '38px' }} required />
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              {strength && (
                <div style={{ marginTop: '0.4rem' }}>
                  ...
                  <span style={{ fontSize: '0.72rem', color: strength.color, fontWeight: 600, marginTop: '0.2rem', display: 'block' }}>{strength.label} password</span>
                </div>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type={showConfirm ? 'text' : 'password'} className="form-input" placeholder="Repeat your password" value={confirmPass} onChange={e => setConfirmPass(e.target.value)} style={{ paddingLeft: '38px', paddingRight: '42px', borderColor: confirmPass && confirmPass !== password ? '#f43f5e' : undefined }} required />
